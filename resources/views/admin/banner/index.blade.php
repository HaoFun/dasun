...
@section('content')
    <div class="content-body">
        <div class="panel panel-default">
            <div class="panel-heading">橫幅圖</div>
            <div>
            ...
            <div class="panel-body">
                <table class="table table-bordered" >
                    <tr>
                        ...
                        <th style="width: 25%" class="text-center">模板名稱</th>
                        <th style="width: 50%" class="hidden-xs text-center">橫幅圖</th>
