        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{ route('admin.setting.update',$setting->id)  }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('config_address') ? 'has-error':''}}">
                    ...
                    <div class="form-group {{ $errors->has('config_email') ? 'has-error':''}}">
                    ...
                    <div class="form-group {{ $errors->has('config_phone') ? 'has-error':''}}">
                    ...
                    <div class="form-group {{ $errors->has('config_house') ? 'has-error':''}}">
                    ...
                    <div class="form-group {{ $errors->has('config_fax') ? 'has-error':''}}">
