...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">編輯橫幅圖片-{{ $banner->banner_title }}</div>
        <div class="panel-body">
            <form action="{{ route('admin.banner.update',$banner->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group {{ $errors->has('banner_title') ? 'has-error':''}}">
                    ...
                    <input type="text"  name="banner_title" value="{{ $banner->banner_title }}" class="form-control" placeholder="請輸入橫幅圖片對應標題">
                </div>
